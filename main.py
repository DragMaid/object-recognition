...
VIDEO_FOLDER = "./sample"
VIDEO_COLLECTIONS = [video for video in listdir(VIDEO_FOLDER)]

print("Choose input video: ")
for index in range(1, len(VIDEO_COLLECTIONS)+1):
    print(f"{index}. {VIDEO_COLLECTIONS[index-1]}", end="\n")

input_index = int(input("Your choice: "))
input_video = "sample/" + VIDEO_COLLECTIONS[input_index-1]
print(input_video)
